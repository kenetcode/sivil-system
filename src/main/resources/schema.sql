...
CREATE TABLE compras_online (
    ...
    estado_compra VARCHAR(20) DEFAULT 'pendiente' CHECK (estado_compra IN ('pendiente', 'procesada', 'enviada', 'entregada', 'cancelada')),
...
CREATE TABLE pagos (
    ...
    estado_pago VARCHAR(20) DEFAULT 'pendiente' CHECK (estado_pago IN ('pendiente', 'completado', 'fallido', 'cancelado')),
