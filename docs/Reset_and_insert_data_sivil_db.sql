-- =========================================
-- 1. LIMPIEZA TOTAL DE TODAS LAS TABLAS
-- =========================================
-- Trunca todas las tablas de la captura de pantalla a la vez.
-- RESTART IDENTITY reinicia los contadores de ID.
-- CASCADE elimina cualquier dependencia que se nos haya pasado.
